...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex h-12 items-center gap-2 border-b border-border",
        className
      )}
      {...props}
    />
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 whitespace-nowrap px-6 py-3 text-sm font-medium transition-all duration-200 cursor-pointer",
